...
import com.speedlaundry.admin.databinding.LaundryCategoryAdapterLayoutBinding;
import com.speedlaundry.admin.http.repository.ApiRepository;
import com.speedlaundry.admin.http.repository.RepositoryEnum;
import com.speedlaundry.admin.laundry_ui.CategoryDetailActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.Holder> {
    ...
    public CategoryAdapter(ArrayList<CategoryItem> categories, Activity activity
    ) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.laundry_category_adapter_layout, parent, false);
        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        LaundryCategoryAdapterLayoutBinding mBinding = holder.mBinding;
    ...
    public class Holder extends RecyclerView.ViewHolder {
        LaundryCategoryAdapterLayoutBinding mBinding;
    ...
    public interface CategoryAdapterClickListener{
        void onCategoryClickListener(CategoryItem categoryItem);
    }

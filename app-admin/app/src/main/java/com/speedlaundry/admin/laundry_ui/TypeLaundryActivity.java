...
import com.speedlaundry.admin.adapter.laundry.TypeLaundryAdapter;
import com.speedlaundry.admin.base_app.MainApplication;
import com.speedlaundry.admin.databinding.ActivityTypeLaundryBinding;
...
public class TypeLaundryActivity extends AppCompatActivity {
    ActivityTypeLaundryBinding mBinding;
    ApiRepository repo = ApiRepository.getInstance();
    ArrayList<TypeLaundryItem> kategoriLaundry = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_type_laundry);
        initView();
        getData();
    }
    public void initView(){
        ...
        mBinding.btnAdd.setOnClickListener(v -> {
            Intent i = new Intent(TypeLaundryActivity.this,
        ...
        repo.setModelListener(MainApplication.api.getTypeLaundry(map),
                new PojoListener<WarpingResponse<TypeLaundryResponse>>() {
                    ...
                    public void onResponseListener(WarpingResponse<TypeLaundryResponse> response) {
                        ...
                        TypeLaundryAdapter categoryAdapter = new TypeLaundryAdapter(kategoriLaundry, TypeLaundryActivity.this);

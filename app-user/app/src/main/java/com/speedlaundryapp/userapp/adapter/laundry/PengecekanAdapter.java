...
import com.speedlaundryapp.userapp.databinding.LaundryPengecekanAdapterBinding;
...
public class PengecekanAdapter extends RecyclerView.Adapter<PengecekanAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        mBinding.InfoType.setText("Tipe : "+orderData.getTypeLaundry().getNama()+" ("+
                GeneralUtil.convertRupiah(Integer.parseInt(orderData.getTypeLaundry().getFee())) +")");

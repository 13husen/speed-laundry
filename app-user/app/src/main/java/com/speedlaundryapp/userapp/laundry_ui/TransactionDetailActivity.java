...
import com.speedlaundryapp.userapp.databinding.ActivityTransactionDetailBinding;
        ...
        repository.setApiListener(MainApplication.api.getTransaction(id),
                (object, codeResponse, rEnum) -> {
                    ...
                    if (rEnum == RepositoryEnum.SUCCESS) {
                        ...
                        Toast.makeText(getApplicationContext(), "ERRTRDEA: " +  object.toString(), Toast.LENGTH_LONG).show();
                    }
                });
    }
        ...
        switch (transactionItem.getStatus()){
                    ...
                    case 4:
                        ...
                        mBinding.btnSubmit.setOnClickListener(v -> {
                            Intent i = new Intent(this, UserTransactionPayActivity.class);
                            i.putExtra("trx_id",transactionItem.getId());
        ...
        if (transactionItem.getTransactionDetail().size() > 0){
            ...
            for (TransactionDetail transactionDetail : transactionItem.getTransactionDetail())
            {
                    ...
                    if (transactionDetail.getItemType() == 1) {
                        keterangan.setText(index + ".) Cucian "+ transactionDetail.getWeight()+ " KG, Kategori "
                        ...
                        String ket = index + ".) Cucian Per-pakaian, Kategori " + transactionDetail.getKategori().getName() + ", Harga Cuci: "+

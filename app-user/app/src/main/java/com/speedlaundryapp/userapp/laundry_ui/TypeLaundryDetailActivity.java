...
import com.speedlaundryapp.userapp.databinding.ActivityTypeLaundryDetailBinding;
        ...
        repository.setApiListener(MainApplication.api.getType(id),
                (object, codeResponse, rEnum) -> {
                    ...
                    if (rEnum == RepositoryEnum.SUCCESS) {
                        ...
                        Toast.makeText(getApplicationContext(), "ERRTYPLNDET: " +  object.toString(), Toast.LENGTH_LONG).show();
                    }
                });
    }
...
//                Toast.makeText(getApplicationContext(), , Toast.LENGTH_SHORT).show();
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "ERRTYPLND: " +  obj.getString("message"), Toast.LENGTH_SHORT).show();
